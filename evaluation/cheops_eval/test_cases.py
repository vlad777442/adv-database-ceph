...
def get_intent_test_cases() -> List[IntentTestCase]:
    ...
    # paraphrase/ambiguous→IntentTestCase(difficulty="hard"),
    ...
    tests += [
        ...
        IntentTestCase("cr01",
                       ...
                       {"failure_domain": "host"},
                       category="crush", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("cr02",
    ...
    tests += [
        ...
        IntentTestCase("mn01",
                       ...
                       "quorum_status",
                       category="monitor", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("mn02",
    ...
    tests += [
        ...
        IntentTestCase("mg09",
                       ...
                       "mgr_module_enable",
                       {"module": "prometheus"},
                       category="mgr", difficulty="medium",
                       requires_ceph=True),
        IntentTestCase("mg10",
    ...
    tests += [
        ...
        IntentTestCase("fs01",
                       ...
                       "fs_new",
                       {"fs_name": "myfs"},
                       category="cephfs", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("fs02",
    ...
    tests += [
        IntentTestCase("ec01",
                       ...
                       "ec_profile_set",
                       {"k": 4, "m": 2},
                       category="erasure_coding", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("ec02",
    ...
    tests += [
        ...
        IntentTestCase("px01",
                       ...
                       category="pg_extended", difficulty="medium",
                       requires_ceph=True),
        IntentTestCase("px02",
                       "Scale up PG count for datapool to 256.",
                       "set_pool_param",
                       {"pool_name": "datapool", "param": "pg_num"},
                       category="pg_extended", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("px03",
    ...
    tests += [
        ...
        IntentTestCase("ox01",
                       ...
                       "osd_df",
                       category="osd_extended", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("ox02",
    ...
    tests += [
        ...
        IntentTestCase("pl01",
                       ...
                       category="pool_extended", difficulty="hard",
                       requires_ceph=True),
        IntentTestCase("pl02",
    ...
    tests += [
        ...
        IntentTestCase("adv01",
                       ...
                       "diagnose_cluster",
                       category="cluster", difficulty="hard",
                       requires_ceph=True),
