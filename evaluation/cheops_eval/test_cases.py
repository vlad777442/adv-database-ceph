...
def get_intent_test_cases() -> List[IntentTestCase]:
    ...
    tests += [
        ...
        IntentTestCase("st05", "how many objects are in the pool?",
                       "get_stats", category="stats", difficulty="medium"),
        ...
        IntentTestCase("st07", "what pools do I have?",
                       ...
                       requires_ceph=True),
        IntentTestCase("st08", "df", "get_stats",
        ...
        IntentTestCase("st19", "give me a storage health dashboard overview",
                       "get_stats", category="stats", difficulty="hard"),
    ...
    tests += [
        IntentTestCase("a01", "show me everything",
                       "list_objects", category="ambiguous",
                       difficulty="hard"),
        ...
        IntentTestCase("a05", "show me stuff",
                       "list_objects", category="ambiguous",
                       difficulty="hard"),
        IntentTestCase("a06", "info", "get_stats",
        ...
        IntentTestCase("a10", "ceph", "cluster_health",
                       ...
                       requires_ceph=True),
        # ── new ambiguous tests ──
        IntentTestCase("a11", "dashboard", "get_stats",
                       category="ambiguous", difficulty="hard"),
        ...
        IntentTestCase("a13", "anything wrong?",
                       "cluster_health", category="ambiguous",
                       difficulty="hard", requires_ceph=True),
        IntentTestCase("a14", "report", "get_stats",
                       category="ambiguous", difficulty="hard"),
    ...
    tests += [
        ...
        IntentTestCase("e02", "???", "help",
                       category="edge_case", difficulty="hard"),
        IntentTestCase("e03", "serch for config files",
                       "semantic_search", {"query": "config"},
                       category="edge_case", difficulty="hard"),
        IntentTestCase("e04", "delet old_file.txt",
                       "delete_object", {"object_name": "old_file.txt"},
                       category="edge_case", difficulty="hard"),
        IntentTestCase("e05", "read file with spaces: my file.txt",
                       "read_object", {"object_name": "my file.txt"},
                       category="edge_case", difficulty="hard"),
        IntentTestCase("e06", "find files matching *.yaml",
                       "semantic_search", {"query": "yaml"},
                       category="edge_case", difficulty="medium"),
        IntentTestCase("e07", "read nonexistent_file_xyz.txt",
                       "read_object",
                       {"object_name": "nonexistent_file_xyz.txt"},
                       category="edge_case"),
        IntentTestCase(
            "e08",
        ...
        IntentTestCase("e09", "ceph -s", "cluster_health",
                       category="edge_case", difficulty="medium",
                       requires_ceph=True),
        IntentTestCase("e10", "rados ls", "list_objects",
                       category="edge_case", difficulty="medium"),
        # ── new edge case tests ──
...
def get_safety_test_cases() -> List[SafetyTestCase]:
    ...
    return [
        ...
        SafetyTestCase("sf03", "pg_status", {},
                       ExpectedRisk.LOW, False,
                       "Read-only PG query"),
        SafetyTestCase("sf04", "list_objects", {},
                       ExpectedRisk.LOW, False,
