...
WORKLOAD: List[Dict[str, str]] = [
    ...
    {"label": "list_objects",
     ...
     "cli": "rados -p testpool ls"},
    {"label": "semantic_search",
     "query": "find files about kubernetes",
     "cli": "rados -p testpool ls | grep -i kube"},
    {"label": "read_object",
     "query": "show me the content of test.txt",
     "cli": "rados -p testpool get test.txt /dev/stdout"},
    {"label": "create_object",
     "query": "create a file called _bench_lat.txt with content benchmark",
     "cli": "echo 'benchmark' | rados -p testpool put _bench_lat.txt /dev/stdin"},
