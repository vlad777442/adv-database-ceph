...
_INTENT_ALIASES: Dict[str, List[str]] = {
    ...
    "pg_status":       ["pg_status", "pg_info", "placement_groups",
                        "diagnose_cluster", "cluster_health"],
    "capacity_prediction": ["capacity_prediction", "capacity",
                            "pool_stats"],
    "performance_stats": ["performance_stats", "perf_stats", "throughput",
                          "osd_status", "diagnose_cluster"],
    ...
    # --- Misc ---
    "help":            ["help", "greeting", "unknown",
                        "cluster_health", "pool_stats"],
